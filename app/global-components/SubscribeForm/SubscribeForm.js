  ...
  return (
    <form className="w-full max-w-140 lg:w-10/12" onSubmit={formHandler}>
      <div className="text-white">
        ...
        <input
          className="block w-full bg-gray-800 rounded-md border-0 p-2.5 text-white shadow-xs ring-1 placeholder:text-gray-400 focus:outline-hidden focus:ring-2 focus:border-black sm:leading-0 text-xs"
          type="email"
          name="email"
          id="email"
        />
