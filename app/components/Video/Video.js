		...
		<section id="video" className="w-full mt-16 lg:mt-56">
			<Container customClasses="flex flex-col lg:flex-row">
				<div
					...
					<p>
						В нашем арсенале — богатая палитра звуков, инструментов, оттенков и эмоций.
						Мы готовы смешивать краски в любых пропорциях, чтобы вы запомнили свой праздник. 
					</p>
				...
				<div className="flex justify-end items-center mt-5 basis-2/4 lg:max-w-lg lg:mt-0 xl:max-w-2xl 2xl:max-w-4xl">
					<iframe title="vimeo-player" src="https://player.vimeo.com/video/1135711690?h=f7cace4b76" width="640" height="360" frameBorder="0" referrerpolicy="strict-origin-when-cross-origin" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"   allowfullscreen></iframe>
				</div>
			</Container>
		</section>
	);
